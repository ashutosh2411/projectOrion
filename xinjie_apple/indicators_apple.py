...
def main(filename):
	...
	i.append( RSI (c,6))
	names.append('rsi'+str(6))
	i.append( RSI (c,12))
	names.append('rsi'+str(12))
	i.append( SMA (c,3))
	names.append('sma'+str(3))
	i.append( EMA (c,6))
	names.append('ema_fast ='+str(6))
	i.append( EMA (c,12))
	names.append('ema ='+str(12))
	i.append( ATR (h,l,c,14))
	names.append('atr'+str(14))
	i.append( MFI (h,l,c,v,14))
	names.append('mfi'+str(14))
	i.append( ADX (h,l,c,14))
	names.append('adx'+str(14))
	i.append( ADX (h,l,c,20))
	names.append('adx'+str(20))
	i.append( MOM (c,1))
	names.append('mom'+str(1))
	i.append( MOM (c,3))
	names.append('mom'+str(3))
	i.append( CCI (h,l,c,12))
	names.append('cci'+str(12))
	i.append( CCI (h,l,c,20))
	names.append('cci'+str(20))
	i.append( ROC (c,3))
	names.append('roc'+str(3))
	i.append( ROC (c,12))
	names.append('roc'+str(12))
	i.append( WILLR (h,l,c,6))
	names.append('willr'+str(6))
	i.append( TSF (c,10))
	names.append('tsf'+str(10))
	i.append( TSF (c,20))
	names.append('tsf'+str(20))
	i.append( TRIX(c,10))
	names.append('trix ='+str(10))

	'''for var in range(1,5):
		i.append( RSI (c,var*6))
...
# Triple exponential average. Smoothens insignificant movements
def TRIX (close, timeperiod=10):
	# TRIPLE EXPONENTIAL MOVING AVERAGE
	real_ = ta.TRIX(close, timeperiod)
	return real_
